...
export default async function RecruiterPage({searchParams}: {searchParams:Promise<{result?:string}>}) {
 ...
 return <main className={styles.root}>
  ...
  <nav className={styles.nav} aria-label="Design Journey sections"><a href="#story">The story</a><a href="#stack">Architecture</a><a href="#delivery">Delivery</a><a href="#v2">V2</a><a href="#standards">Standards</a><a href="#evidence">Evidence</a><a href="#next">Next steps</a></nav>
