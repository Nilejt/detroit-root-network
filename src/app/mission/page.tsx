...
export default async function MissionPage() {
  ...
  return (
    <main className={styles.root}>
      ...
      <div className={styles.content}><p>Sources: <a href="https://www.mdpi.com/2071-1050/16/16/7109">Detroit food landscape study (2024)</a> · <a href="https://easternmarket.org/who-we-are/">Eastern Market history</a></p><p>Owner and Director Q: sign in through <Link href="/">Farmer tools</Link>, then return here to suggest and review edits.</p></div>
