...
// Public editorial page: no session or farm records are needed. Keep research
// dates and scopes attached to claims; future Grow features must stay labeled.
  ...
  return (
    <main className={styles.root}>
      ...
      <div className={styles.content}>
        <section><p className={styles.eyebrow}>A CLEARER PICTURE</p><h2>Food access changes. Our understanding should, too.</h2>
        ...
        <section><p className={styles.eyebrow}>THREE EXPERIENCES · ONE LOCAL NETWORK</p><h2>An accessible core. Room to grow.</h2><div className={styles.cards}>
